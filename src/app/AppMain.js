...
import TrainingSchedule from "./Pages/Computer Training/Option/TrainingSchedule";
      ...
      <div className="">
        ...
        <Switch>
          <Suspense fallback={loading()}>
            ...
            <Route exact path="/trainingschedule" component={TrainingSchedule}></Route>
            ...
            <Route exact path="/pdf" component={PDFReader}></Route>
