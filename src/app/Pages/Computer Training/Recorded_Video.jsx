...
const Recorded_Video = ({
  ...
  const flagManage = useSelector((state) => state.flagReducer.flag);
  console.log(
    "🚀 ~ file: Recorded_Video.jsx ~ line 51 ~ flagManage",
    flagManage
  );
  //
                          ...
                          <div className="position-relative">
                            {pdf ? (
                              <>
                                <a
                                  href={
                                    pdf.fileURL ? pdf.fileURL : Bucket + pdf
                                  }
                                  target="_blank"
                                >
                                  <MdPictureAsPdf
                ...
                {state === accountData[0]?.subject.length - 1 ? (
                  <div className="d-flex align-items-center">
                    ...
                    {accountData[0]?.isExamGiven === false && (
                      <>
                        {accountData &&
                          accountData[0]?.isDocument === false &&
                          state === accountData[0]?.subject.length - 1 && (
                            <button
                              className="linear_gradient rounded border-none w-25  text-white font_bold font_capital py-1 ml-3"
                              // onClick={() => history.push("/mcqTest?id=" + accountData[0]._id)}
                              onClick={() =>
                                uploadDoc(accountData[0]?.subject.length)
                              }
                            >
                              Upload Document
                            </button>
