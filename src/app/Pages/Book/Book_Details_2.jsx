      ...
      <div className="row py-3">
        {data?.length > 0 ? (
          data.map((book, i) => {
            return (
              <div
                className="col-md-6 col-xxl-3 col-lg-3 py-3 d-flex"
                role="button"
              ...
              >
                <div className="images">
                  <p className="imgThumb1">
                    ...
                    <span>
                      <div
                        className="navHover"
                      // to={{ pathname: "/viewBook", state: book._id }}
                      >
                        <button
                ...
                <div className="p-2 d-flex flex-column justify-content-between w-50">
                  <div className="">
                    <h3 className="font_size_16 font_bold color_gray mb-1 responsivEllipsis">
                      {book.title}
                    </h3>
