...
const OtpScreen = ({
  ...
  const [resendOtp, setResedOtp] = useState(false);
  const [resendOtp2, setResedOtp2] = useState(false);
      ...
      <div className="d-flex pr-2 justify-content-center">
        ...
        <div className="col-md-4 px-2">
          {/* <button
            ...
            // disabled={button}
          > */}
          <button className="signBtn w-100 rounded" onClick={emailVarification}>
