...
import carousel from "../../media/a3.png";
import carousel1 from "../../media/a1.png";
import carousel2 from "../../media/a2.png";
...
const Home = () => {
  ...
  const callParticularData = (i, pagsize, currentpag) => {
    ...
    if (token) {
      ...
      ApiPostNoAuth("teacher/book/" + txt, body)
        .then((res) => {
          console.log(res);
          setbook(res.data.data.book_data);
          settotalpage(res.data.data.state.page_limit);
